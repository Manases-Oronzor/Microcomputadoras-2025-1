...
#####################################################################
####                                                             ####
####    IMPLEMENTACIÓN DE UNA RED NEURONAL BASADA EN microMLP    ####
####    NOTA: Como no se pudo integrar la librería por los       ####
####          medios convencionales se optó por copiarla         ####
####          dentro del mismo archivo de solución del proble-   ####         ####
####          ma de la "OR EXCLUSIVA".                           ####
####                                                             ####
#####################################################################
#####################################################################
#####################################################################
...
####                                                             ####
####         Librería microMLP + Programa OR EXCLUSIVA           ####
####                                                             ####
#####################################################################
#####################################################################
#####################################################################
